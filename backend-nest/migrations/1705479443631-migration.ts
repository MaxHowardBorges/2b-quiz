...
export class Migration1705479443631 implements MigrationInterface {
    name = 'Migration1705479443631'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`session\` (\`id\` int NOT NULL AUTO_INCREMENT, \`isResult\` tinyint NOT NULL, \`isGlobal\` tinyint NOT NULL, \`isResponses\` tinyint NOT NULL, \`date\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP(), \`questionnaryId\` int NULL, \`teacherId\` int NULL, UNIQUE INDEX \`REL_59c3b562e89b59ec72e80061f1\` (\`questionnaryId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`questionnary\` ADD \`isCompilated\` tinyint NOT NULL DEFAULT false`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`questionnary\` DROP COLUMN \`isCompilated\``);
