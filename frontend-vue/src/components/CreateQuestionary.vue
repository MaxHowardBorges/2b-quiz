<template>
  <div class="create-questionnaire-page">
    ...
    <div class="question-type">
      <button @click="selectQuestionType('vrai-ou-faux')">type de question</button>
      <button @click="selectQuestionType('nuage-de-mots')">type de question</button>
      <button @click="selectQuestionType('reponse-multiple')">type de question</button>
    </div>
